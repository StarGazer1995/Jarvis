...
from ..utils.error_handler import LLMConfigurationError
...
class MockLLMClient(BaseLLMClient):
    ...
    def _generate_mock_content(self, last_message: Optional[LLMMessage], messages: List[LLMMessage] = None) -> str:
        ...
        Returns:
            Mock响应内容
        """
        # Check if we are in a ReAct context (system prompt mentions ReAct)
        is_react = False
        if messages:
            for msg in messages:
                if msg.role == "system" and "ReAct" in msg.content:
                    is_react = True
                    break
        ...
        if last_message and last_message.content:
            ...
            # 告别语
                ...
                response_text = "Goodbye! It was nice talking with you. Have a great day!"
            
            # 询问能力
            elif any(capability in user_input_lower for capability in ["what can you do", "capabilities", "你能做什么", "功能"]):
                response_text = ("I'm an AI assistant powered by ARK engine. I can help you with various tasks including "
            ...
            # 询问名字
                ...
                response_text = "I'm Jarvis, an AI assistant built with the ARK (Adaptive Reasoning Kernel) engine. Nice to meet you!"
            
            # 感谢
            elif any(thanks in user_input_lower for thanks in ["thank", "thanks", "谢谢", "感谢"]):
                response_text = "You're welcome! I'm happy to help. Is there anything else you'd like to know?"
            ...
            # 询问天气
                ...
                response_text = ("I don't have access to real-time weather data right now, but I can help you find weather "
            ...
            # 数学问题
                ...
                response_text = ("I can help with mathematical calculations! Please provide me with the specific calculation "
                       "you'd like me to perform.")
            
            # 编程相关
            elif any(code_word in user_input_lower for code_word in ["code", "programming", "编程", "代码"]):
                response_text = ("I can assist with programming tasks! I can help explain code, debug issues, suggest "
                       "improvements, or help you write new code. What programming task are you working on?")
            
            # 帮助
            elif "help" in user_input_lower:
                response_text = "I'm here to help! This is a mock response for testing purposes."
            
            # Python相关
            elif "python" in user_input_lower:
                response_text = "Python is a great programming language! Here's some mock information about Python development."
            ...
            # 默认智能响应
                ...
                if messages:
                    ...
                    if conversation_length <= 2:
                        response_text = (f"I understand you're asking about '{user_input}'. That's an interesting topic! "
                               f"Could you provide more details about what specifically you'd like to know?")
                    else:
                        response_text = (f"Based on our conversation, I can see you're interested in '{user_input}'. "
                               f"Let me provide some helpful information about that topic. "
                               f"What specific aspect would you like me to focus on?")
                else:
                    # 随机选择一个模板响应
                    response_text = random.choice(self._response_templates)
        else:
            response_text = random.choice(self._response_templates)
            
        # Wrap in ReAct format if needed
        if is_react:
            # If we already have a response, just wrap it in Final Answer
            # Unless we want to simulate an action (which is harder to trigger deterministically without more logic)
            return f"Thought: The user is asking a question or greeting. I should respond directly.\nFinal Answer: {response_text}"
