...
from src.core.ark.engine import ARKEngine, ARKState, TaskStatus

class TestARKEngineReAct(unittest.IsolatedAsyncioTestCase):
    ...
    async def asyncSetUp(self):
        ...
        self.engine.mcp_client.execute_tool = AsyncMock(return_value="Tool executed successfully")
...
"""
        ...
        self.assertEqual(final_response, "I have added 'Buy groceries' to your todo list.")
...
"""
        ...
        self.engine.mcp_client.execute_tool.assert_called_with("weather_tool", {"location": "New York"})
