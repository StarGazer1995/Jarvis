...
async def main():
    ...
    registry.register_agent(AgentSpec(name="Researcher", description="Finds information.", node=research_node))
    registry.register_agent(AgentSpec(name="Writer", description="Writes content based on research.", node=writer_node))
