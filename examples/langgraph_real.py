...
async def main():
    ...
    if llm_config.provider.value == "mock":
        logger.warning("WARNING: LLM_PROVIDER not set or set to 'mock'. This will use the Mock client!")
        logger.warning("To use a real LLM, set LLM_PROVIDER=openai (or litellm) and OPENAI_API_KEY.")
