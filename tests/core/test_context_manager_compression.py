...
from src.core.config_loader import LLMConfig, ProviderConfig, GlobalConfig
...
async def test_compress_history_triggers_compression(mock_llm_config):
    ...
    # Mock dependencies
    with patch("src.core.context_manager.load_llm_config", return_value=mock_llm_config), \
         patch("src.core.context_manager.ChatOpenAI") as MockChatOpenAI, \
         patch("src.core.context_manager.PromptTemplate") as MockPromptTemplate, \
         patch("src.core.context_manager.StrOutputParser") as MockStrOutputParser:
...
async def test_compress_history_below_threshold(mock_llm_config):
    ...
    with patch("src.core.context_manager.load_llm_config", return_value=mock_llm_config) as mock_load:
