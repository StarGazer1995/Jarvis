...
class TestInputValidator:
    ...
    def test_validate_domain_allowed(self):
        ...
        assert InputValidator.validate_domain(
...
class TestARKSecurityManager:
    ...
    def test_register_custom_validator(self, security_manager):
        ...
        result = security_manager.register_custom_validator("test_validator", custom_validator)
        assert result is True
        assert "test_validator" in security_manager.custom_validators
    
    @pytest.mark.asyncio
    async def test_validate_tool_execution_allowed(self, security_manager, sample_context):
    ...
    @pytest.mark.asyncio
    async def test_validate_tool_execution_denied_permission(self, security_manager, sample_context):
    ...
    @pytest.mark.asyncio
    async def test_validate_tool_execution_requires_approval(self, security_manager, sample_context):
    ...
    @pytest.mark.asyncio
    async def test_validate_tool_execution_rate_limited(self, security_manager, sample_context):
    ...
    @pytest.mark.asyncio
    async def test_validate_tool_execution_input_size_exceeded(self, security_manager, sample_context):
    ...
    @pytest.mark.asyncio
    async def test_validate_tool_execution_blocked_file_path(self, security_manager, sample_context):
    ...
    @pytest.mark.asyncio
    async def test_validate_tool_execution_blocked_domain(self, security_manager, sample_context):
    ...
    @pytest.mark.asyncio
    async def test_validate_tool_execution_custom_validator_fail(self, security_manager, sample_context):
        ...
        security_manager.register_custom_validator("failing_validator", failing_validator)
    ...
    @pytest.mark.asyncio
    async def test_validate_tool_execution_invalid_policy(self, security_manager, sample_context):
        ...
        response = await security_manager.validate_tool_execution(request, "non_existent")
...
class TestSecurityManagerIntegration:
    ...
    async def test_policy_hierarchy_enforcement(self):
        ...
        response = await security_manager.validate_tool_execution(system_request, "medium")
        assert response.result == ValidationResult.DENIED
        
        # Should require approval in high policy
        response = await security_manager.validate_tool_execution(system_request, "high")
        assert response.result == ValidationResult.DENIED  # Still denied as SYSTEM not in high policy
        
        # Should require approval in critical policy
        response = await security_manager.validate_tool_execution(system_request, "critical")
        assert response.result == ValidationResult.REQUIRES_APPROVAL