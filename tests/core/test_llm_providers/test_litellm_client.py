...
from src.core.llm_providers.litellm_client import LiteLLMClient
from src.core.llm_client import LLMConfig, LLMMessage, LLMResponse, LLMProvider
...
class TestLiteLLMClient:
    ...
    async def test_initialize_failure_import_error(self, litellm_client):
        ...
        with patch.dict(sys.modules):
            ...
            with patch('src.core.llm_providers.litellm_client.LiteLLMClient.initialize', side_effect=LLMConfigurationError("LiteLLM库未安装")):
