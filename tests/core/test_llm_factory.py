...
from src.core.llm_client import BaseLLMClient, LLMProvider, LLMConfig as ClientLLMConfig
...
class TestLLMProviderFactory:
    ...
    def test_factory_init_without_config_path(self):
        """测试不使用配置文件路径初始化工厂"""
        with patch('src.core.llm_factory.load_llm_config') as mock_load:
            mock_config = Mock()
...
class TestCreateLLMClient:
    ...
    def setup_method(self):
        ...
        src.core.llm_factory._factory = None
    
    @patch('src.core.llm_factory.LLMProviderFactory')
