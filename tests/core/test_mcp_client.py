...
from src.core.server_config import SimpleMCPServerConfig, ServerStatus
...
class TestARKMCPClientErrorHandling:
    ...
    async def test_demo_server_configuration_error(self, client):
        ...
        with patch('src.core.mcp_client.SimpleMCPServerConfig') as mock_config:
...
class TestARKMCPClientAdvancedFeatures:
    ...
    async def test_connect_to_server_internal_error_handling(self, client):
        ...
        with patch('src.core.mcp_client.stdio_client') as mock_stdio:
    ...
    async def test_connect_to_server_internal_success_path(self, client):
        ...
        with patch('src.core.mcp_client.stdio_client', return_value=mock_context), \
             patch('src.core.mcp_client.ClientSession', return_value=mock_session):
