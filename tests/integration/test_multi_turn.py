...
async def test_multi_turn_conversation_flow():
    ...
    with patch('src.core.ark.engine.LLMManager') as MockLLMManager, \
        ...
        async def side_effect(initial_state, config=None):
            ...
            history_text = " ".join([m.content for m in messages if isinstance(m, (HumanMessage, AIMessage))])
        ...
        assert engine.context_manager.conversation_history[0].user_input == "My name is John"
